...
ALTER TABLE fila_cliente
  ADD COLUMN data_inicio_atendimento DATETIME NULL AFTER data_entrada,
  ADD COLUMN data_fim_atendimento DATETIME NULL AFTER data_inicio_atendimento;
...
ADD COLUMN raio_km DECIMAL(5,2) DEFAULT 0.2;
